<h1 align="center">Hi, I'm Shiva Krishna Arjula 👋</h1>

<p align="center">
  <strong>Senior Data Analyst / SME &nbsp;·&nbsp; SQL &nbsp;·&nbsp; Snowflake &nbsp;·&nbsp; Python &nbsp;·&nbsp; dbt &nbsp;·&nbsp; Power BI &nbsp;·&nbsp; Tableau</strong>
</p>
...
**Capital One &nbsp;·&nbsp; Senior Data Analyst / SME — Banking Analytics, STTM & Data Migration** &nbsp;&nbsp;&nbsp;*(Jul 2023 – Present)*
...
- Promoted to Assistant Manager — led STTM documentation, data migration validation, and reconciliation frameworks for banking domain Data Warehouse initiatives across Snowflake, Teradata, Oracle, and SQL Server
...
**IQLOGG Inc (Capital One) &nbsp;·&nbsp; Business Analyst Consultant** &nbsp;&nbsp;&nbsp;*(Oct 2016 – Nov 2018)*

- Started career supporting banking domain data warehouse and STTM initiatives at Capital One — gathered requirements, produced functional documentation, and analyzed banking data using SQL
- Identified data integration risks and KPI inconsistencies early — built the data governance instinct that underpins 10 years of progressive financial services growth
